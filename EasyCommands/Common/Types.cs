...
namespace IngameScript {
    partial class Program {
        #region mdk preserve
        public enum Block { PISTON, ROTOR, PROGRAM, TIMER, LIGHT, PROJECTOR, MERGE, CONNECTOR, WELDER, GRINDER, DOOR, DISPLAY, SOUND, CAMERA, SENSOR, BEACON, ANTENNA, COCKPIT, REMOTE, THRUSTER, AIRVENT, GUN, REACTOR, GENERATOR, TANK, GEAR, BATTERY, PARACHUTE, SUSPENSION, DETECTOR, DRILL, ENGINE, SORTER, TURRET, GYROSCOPE, GRAVITY_GENERATOR, GRAVITY_SPHERE, CARGO, WARHEAD }
        public enum Property { POWER, CONNECTED, LOCKED, COMPLETE, OPEN, TRIGGER, PRODUCE, AUTO, OVERRIDE, HEIGHT, ANGLE, VELOCITY, RATIO, FONT_SIZE, VOLUME, RANGE, MOVE_INPUT, ROLL_INPUT, NAME, RUN, TEXT, COLOR, SONG, BLINK_INTERVAL, BLINK_LENGTH, BLINK_OFFSET, INTENSITY, FALLOFF, POSITION, DIRECTION, TARGET, TARGET_VELOCITY, STRENGTH, COUNTDOWN, SILENCE }
