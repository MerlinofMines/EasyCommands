...
namespace IngameScript {
    partial class Program {
        ...
        public enum Property { POWER, CONNECTED, LOCKED, COMPLETE, OPEN, TRIGGER, PRODUCE, AUTO, OVERRIDE, HEIGHT, ANGLE, VELOCITY, RATIO, FONT_SIZE, VOLUME, RANGE, MOVE_INPUT, ROLL_INPUT, NAME, RUN, TEXT, COLOR, SOUND, BLINK_INTERVAL, BLINK_LENGTH, BLINK_OFFSET, INTENSITY, FALLOFF, POSITION, DIRECTION, TARGET, TARGET_VELOCITY, STRENGTH, COUNTDOWN }
