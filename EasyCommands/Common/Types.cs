...
namespace IngameScript {
    partial class Program {
        ...
        public enum Property { ENABLE, POWER, CONNECTED, LOCKED, COMPLETE, OPEN, TRIGGER, SUPPLY, AUTO, OVERRIDE, LEVEL, ANGLE, VELOCITY, RATIO, FONT_SIZE, VOLUME, RANGE, INPUT, ROLL_INPUT, NAME, RUN, TEXT, COLOR, SONG, BLINK_INTERVAL, BLINK_LENGTH, BLINK_OFFSET, INTENSITY, FALLOFF, POSITION, DIRECTION, TARGET, TARGET_VELOCITY, STRENGTH, COUNTDOWN, SILENCE, SHOW, PROPERTIES }
        public enum ValueProperty { AMOUNT, CREATE, DESTROY, PROPERTY };
